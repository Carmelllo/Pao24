...
namespace {
struct qt_meta_tag_ZN9EditMediaE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN9EditMediaE = QtMocHelpers::stringData(
    "EditMedia",
    "onApply",
    "",
    "AbstractMedia*",
...
Q_CONSTINIT static const uint qt_meta_data_ZN9EditMediaE[] = {
...
Q_CONSTINIT const QMetaObject EditMedia::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ZN9EditMediaE.offsetsAndSizes,
    qt_meta_data_ZN9EditMediaE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9EditMediaE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<EditMedia, std::true_type>,
        // method 'onApply'
...
void EditMedia::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (EditMedia::*)(AbstractMedia * );
            if (_q_method_type _q_method = &EditMedia::onApply; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *EditMedia::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9EditMediaE.stringdata0))
