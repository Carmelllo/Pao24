...
QT_MOC_LITERAL(19, 0), // ""
QT_MOC_LITERAL(20, 12), // "std::string&"
QT_MOC_LITERAL(33, 6) // "search"

    },
    "SearchBar\0onSearch\0\0std::string&\0"
    "search"
};
...
void SearchBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onSearch((*reinterpret_cast< std::add_pointer_t<std::string&>>(_a[1]))); break;
        ...
        {
            using _t = void (SearchBar::*)(std::string & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchBar::onSearch)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<SearchBar, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<std::string &, std::false_type>
...
// SIGNAL 0
void SearchBar::onSearch(std::string & _t1)
{
